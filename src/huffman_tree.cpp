...
namespace huffman {
    ...
    int huffman_tree_node::get_frequency() const {
        return frequency_;
    }

    int huffman_tree::get_alphabet_power() const {
        return alphabet_power_;
    }

    std::map<char, int> huffman_tree::get_chars_frequency() const {
        return chars_frequency_;
    }

    int huffman_tree::get_number_of_chars() const {
        return number_of_chars_;
    }
    ...
    huffman_tree_node *huffman_tree_node::get_left_child() const {
        return left_child_;
    }

    huffman_tree_node *huffman_tree_node::get_right_child() const {
        return right_child_;
    }

    char huffman_tree_node::get_symbol() const {
        return symbol_;
    }
    ...
    std::map<char, std::string> huffman_tree::get_table() const {
        return table_;
    }

    void huffman_tree::set_alphabet_power(const int value) {
        alphabet_power_ = value;
    }

    void huffman_tree::add_symbol(const char symbol, const int frequency) {
        chars_frequency_.insert({symbol, frequency});
    }

    // builds table with binary codes
    void huffman_tree::build_table() {
        build_code(root_, "");
    }
